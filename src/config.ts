...
const envSchema = z.object({
  ...
  STRIPE_STANDARD_RESERVATION_DEPOSIT_AMOUNT_CENTS: z.coerce.number().int().positive().default(2000),
  STRIPE_LARGE_PARTY_RESERVATION_DEPOSIT_AMOUNT_CENTS: z.coerce.number().int().positive().default(10000),
